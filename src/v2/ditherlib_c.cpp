...
// ===============================================
// 8×8 Bayer-style ordered dither threshold matrix
// ===============================================
// 
// Values represent thresholds in [0, 63/64]. For a planned mixing ratio R:
//   - If threshold[x%8][y%8] < R → output colour2
//   - Else → output colour1
// This spatially distributes the two colours according to the planned proportion.
// The pattern minimises low-frequency banding and avoids visible clumping.
#define d(x) x/64.0
